...
`activity_labels.txt` file has the list of all the output labels.

`train/` directory has training data and `test/` directory has the test data

### Transformations on the Dataset

Following transformations are performed as part of this project on raw data set.
